...
if(isset($_SESSION['insert_photo_id'])){
	...
	$photoFile="images/cherryboard/".$photo_name;
	...
	<?php
		...
		if(mysql_num_rows($selSqlQ)>0){
			...
			while($rowTbl=mysql_fetch_array($selSqlQ)){
				...
				$FriendsCnt.='<div class="small_thumb_container">
					<div class="feedbox_holder">
						<div class="actions">'.($user_id==USER_ID?'<a class="delete" href="#" onclick="ajax_action(\'delete_goal_recent_friends\',\'div_goal_recent_friends\',\'cherryboard_id='.$cherryboard_id.'&meb_id='.$meb_id.'&user_id='.USER_ID.'\')" ><img src="images/delete.png"></a>':'').'</div>
					</div>
...
<div id="body_container">
	<div class="wrapper" style="padding: 0px;">
	  ...
	  <div style="position: absolute;margin-left:665px;">
	   		<table><tr><td><a title="Sort" name="Sort" href="javascript:void(0);" onclick="javascript:ajax_action('photo_refresh','right_container','cherryboard_id=<?=$cherryboard_id?>&sort=desc')"><img title="Desceding" src="images/des.jpg" height="35" width="35"/></a></td><td><img id="rotate_asc" src="images/transparent.png" height="35" width="35"/></td></tr></table>
	   </div>
	  	  <?php		  
							...
							<div class="img_big_container3">
								<div class="feedbox_holder">
								 ...
								 <div class="send_message">
									<div class="actions1"><a rel="leanModal" href="#sendThankYou" title="Send Thank You" class="msg">Send Thank You</a></div>
								 </div>
								  <img src="'.$photoPath.'">
							   </div>
		...
		<div class="bottom1">';
			...
			if($checkCheers==0){
				$cheersLink='<div class="likes"><a href="javascript:void(0);" onclick="add_cherry_cheers(\'add_cheers\',\''.$photo_id.'\',\''.$cherryboard_id.'\',\''.USER_ID.'\')" class="likes">Cheers!</a></div>';
			}else{$cheersLink='';}
...
$photoCnt.='</div>';
			if($TotalCmt>0){
			  ...
			  while($cmtRow=mysql_fetch_array($selCmt)){
				   ...
				   $photoCnt.='<div class="leandro">
					 <div class="maryfeed"><div class="action"><a class="delete" href="javascript:void(0);" onclick="add_cherry_comment(event,\'del_cherry_comment\','.$cherryboard_id.','.$photo_id.','.$cmtRow['user_id'].','.$comment_id.')"><img src="images/delete.png" title="Delete"></a></div></div>
		...
		$photoCnt.='</div><div class="add1">
			 ...
			 <div class="add_txt">
			 <textarea name="cherry_comment_'.$photo_id.'" class="input_comments" id="cherry_comment_'.$photo_id.'" onfocus="if(this.value==\'Add a comment...\') this.value=\'\';" onblur="if(this.value==\'\') this.value=\'Add a comment...\';" style="height: 30px;width: 130px;">Add a comment...</textarea>
			 
			 </div>
			 <div class="add_btn"><img style="cursor:pointer" src="images/btn_comment.png" onclick="return add_cherry_comment(event,\'add_cherry_comment\',\''.$cherryboard_id.'\',\''.$photo_id.'\',\''.USER_ID.'\',document.getElementById(\'cherry_comment_'.$photo_id.'\').value)">
			 </div>
    </div>';		   
...
<div style="display: none; position: fixed; opacity: 1; z-index: 11000; left: 50%; margin-left: -330px; top: 100px; width:260px;" id="sendThankYou" class="popup_div">
...
<!-- javascript:return CheckFormValidation('div_frm_sndmsg','send_email#Enter Email#Enter Email#'); -->
</form>
