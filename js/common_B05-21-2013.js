...
{	
	...
	if(type=="add_cherry_expert_comment"){
...
function delExpert(totalExpert){
	if(totalExpert>0){
		alert('Cannot delete the expertboard as there are goal boards associated with this expertboard');
		return false;	
	}else{
