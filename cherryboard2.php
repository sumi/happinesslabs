...
while($cherryRow=mysql_fetch_array($cherrySel)){
	...
	$gift_id=getFieldValue('gift_id','tbl_app_cherry_gift','cherryboard_id='.$cherryboard_id);
	$campaignDetail=getFieldsValueArray('campaign_title,campaign_detail,goal_days,miss_days,sponsor_name,sponsor_url,sponsor_logo','tbl_app_gift','gift_id='.$gift_id);
	$campaign_detail='';
...
<div id="my_cherryleaders"><a href="#" class="get_another_gift left">&nbsp;</a>&nbsp;<?=$giftMsg?><br>
	...
	<?php 
	echo '<br><br><br><br>'.$gift_title;
	echo '<br/><table><tr><td>Sponsored By :</td><td>'.$sponsorLink.'</td><td><a href="'.$sponsor_url.'" style="text-decoration:none;color:#990000">'.$sponsor_name.'</a></td></tr></Table>';
	?>
	</div>	
</div>
</div>
   ...
   <?php
    ...
    <?php if($msg!=""){ ?>
		...
		<div>
		<Table>
		<tr><td valign="top"><table><tr><Td valign="top">Detail&nbsp;:&nbsp;</Td><td><?=$campaign_detail?></td></tr></table></td></tr>
	  	<tr><td>Goal&nbsp;Type&nbsp;:&nbsp;<?=ucwords($category_name)?></td></tr>
		<tr><td>Days&nbsp;:&nbsp;<?=$goal_days?>,&nbsp;&nbsp;Strikes : <?=$miss_days?></td></tr>
		</Table>
		</div>
...
<div id="body_container">
	<div class="wrapper">
	  ...
	  <div style="padding-left:30px"><a title="Sort" class="btn_small" name="Sort" href="javascript:void(0);" onclick="javascript:ajax_action('photo_refresh','right_container','cherryboard_id=<?=$cherryboard_id?>&sort=desc')">Descending</a></div>
	  
	  	  <?php
		  $DaysTitleArr=array("CrossTrain", "Cardio", "Strength", "Yin", "Detox", "Vitality", "Mountain Pose", "CrossTrain", "Cardio", "Strength", "Yin", "Detox", "Vitality", "Mountain Pose", "CrossTrain", "Cardio", "Strength", "Yin", "Detox", "Vitality", "Mountain Pose", "CrossTrain", "Cardio", "Strength", "Yin", "Detox", "Vitality", "Mountain Pose", "CrossTrain", "Cardio", "Strength", "Detox", "Mountain Pose", "Gentle", "Yin", "36 Sun Salutations", "Balance", "Strength", "Flexibility", "Gentle", "Detox", "Cardio", "Mountain Pose", "Balance", "Strength", "Flexibility", "Gentle", "Detox", "Cardio", "Mountain Pose", "Balance", "Strength", "Flexibility", "Gentle", "Detox", "Cardio", "Mountain Pose", "Balance", "Strength", "Flexibility", "Gentle", "Detox", "Cardio", "Mountain Pose", "Balance", "Strength", "Flexibility", "Detox", "Mountain Pose", "Gentle", "Yin", "72 Sun Salutations", "Cross Train", "Strength", "Balance", "Yin", "Cardio", "Vitality", "Mountain Pose", "CrossTrain", "Strength", "Balance", "Yin", "Cardio", "Vitality", "Mountain Pose", "CrossTrain", "Strength", "Balance", "Yin", "Cardio", "Vitality", "Mountain Pose", "CrossTrain", "Strength", "Balance", "Yin", "Cardio", "Vitality", "Mountain Pose", "CrossTrain", "Strength", "Balance", "Cardio", "Mountain Pose", "Gentle", "Yin", "108 Sun Salutations");
		  //CHERRYBOARD PHOTOS
			  ...
			  while($selphotoRow=mysql_fetch_array($selphoto)){
				  ...
				  <div class="tag_container">
					<div class="comment_box1" style="cursor:pointer;height:30px;" ondblclick="ajax_action(\'upd_photo_title\',\'photo_title'.$photo_id.'\',\'stype=add&photo_id='.$photo_id.'\')" id="photo_title'.$photo_id.'">&nbsp;'.getLimitString($photo_title,55).'</div><div class="clear"></div>
						<div class="info_box">
							<div class="score">'.$DaysTitleArr[(1-$photo_day)].'</div>
