...
/*
URL :-> https://www.happinesslabs.com/app_services.php?type=share_on_email&fb_id=[user fb id]
&cherryboard_id=[cherryboard_id]&user_id=[user_id]&email_id=[email_id]&subject=[subject]&message=[message]
TESTED URL :-> https://www.happinesslabs.com/app_services.php?type=share_on_email&fb_id=100005132283550&cherryboard_id=346&user_id=96&email_id=suresh.uniquewebinfo@gmail.com&subject=test&message=this%20is%20test%20message
*/
if($type=='share_on_email'){
   ...
   $tblData['status']=trim($_REQUEST['message']);
	  ...
	  foreach($send_emailArr as $email_id){	  	
		if($email_id!=''){
		   ...
		   $tblData['status']='<table>
			...
			if(SendMail){
			   $tblData['status']='Share On Email Successfully.';
			}
		}
	  }
   }else{
...
/*
URL :-> https://www.happinesslabs.com/app_services.php?type=send_story_request&fb_id=[user fb id]
&cherryboard_id=[cherryboard_id]&uid=[user fb id]&request_ids=[requestid request user fb id]
TESTED URL :-> https://www.happinesslabs.com/app_services.php?type=send_story_request&fb_id=100005132283550&cherryboard_id=346&uid=100005132283550&request_ids=121884434647423_100002411518620 */
		   ...
		   $chkUser=(int)getFieldValue('meb_id','tbl_app_expert_cherryboard_meb','req_user_fb_id='.$req_user_fb_id[1].' AND cherryboard_id='.$cherryboard_id);
			if($chkUser==0){
			   ...
			   $ins_sql=mysql_query($insMeb);
				...
				if(SendMail){
				   $tblData['status']='Request Send Successfully.';
			    }
			}	
		}
		$cnt++;
...
//START DELETE PHOTO 
/*
URL :-> https://www.happinesslabs.com/app_services.php?type=delete_photo&fb_id=[user fb id]
&del_photo_id=[photo_id]
TESTED URL :->
https://www.happinesslabs.com/app_services.php?type=delete_photo&fb_id=100005132283550&del_photo_id=982*/
   ...
   if($del_photo_id>0&&$user_id>0){
	  ...
	  if(is_file($photo_path)&&$user_id==$UserId){
		 ...
		 if($delPhoto){
			...
			unlink($sliderPath);
	  		$tblData['status']='Photo Deleted Successfully.';
		 }
	  }
   }else{
   		$tblData['status']='Invalid Data';
...
/*
URL :-> https://www.happinesslabs.com/app_services.php?type=delete_storyboard&fb_id=[user fb id]
&delExpId=[expertboard_id]
TESTED URL :-> 
https://www.happinesslabs.com/app_services.php?type=delete_storyboard&fb_id=100005132283550&delExpId=232*/
	  ...
	  if($user_id==$UserId&&$cherryboard_id>0){
		 ...
		 if($delStoryBoard){
			...
			deleteExpertBoard($cherryboard_id);//call function deleteExpertBoard
	  		$tblData['status']='StoryBoard Deleted Successfully.';
		 }
	  }	
   }else{
   	$tblData['status']='Invalid Data';
...
/*
URL :-> https://www.happinesslabs.com/app_services.php?type=update_photo_title&fb_id=[user fb id]
&photo_id=[photo_id]&photo_title=[photo title]
TESTED URL :-> https://www.happinesslabs.com/app_services.php?type=update_photo_title&fb_id=100005132283550&photo_id=144&photo_title=good */
if($type=='update_photo_title'){
   ...
   if($updtTitle){
	  $tblData['status']='Title Updated Successfully.';
   }
}
//START UPDATE PHOTO THEME
/*
URL :-> https://www.happinesslabs.com/app_services.php?type=update_photo_theme&fb_id=[user fb id]
&photo_day=[photo day]&sub_day=[sub day]&expertboard_id=[expertboard_id]&photo_theme=[photo day title]
TESTED URL :->
https://www.happinesslabs.com/app_services.php?type=update_photo_theme&fb_id=100005132283550&photo_day=1&sub_day=1&expertboard_id=9&photo_theme=Day 1 */
if($type=='update_photo_theme'){
   ...
   if($updtTheme){
	  $tblData['status']='Theme Updated Successfully.';
   }
}
//START DELETE REWARD
/*
URL :-> https://www.happinesslabs.com/app_services.php?type=delete_reward&fb_id=[user fb id]
&expRewardId=[reward id]&user_id=[user id]
TESTED URL :->
https://www.happinesslabs.com/app_services.php?type=delete_reward&fb_id=100005132283550&&expRewardId=100&user_id=96
*/
if($type=='delete_reward'){
   ...
   if($expRewardId>0&&$user_id==$UserId){
	  ...
	  if($delReward){
		 unlink($photo_path);
		 $tblData['status']='Reward Deleted Successfully.';
	  }	
   }else{
   		$tblData['status']='Invalid Data';
   }
...
//START ADD REWARD
/*
URL :-> https://www.happinesslabs.com/app_services.php?type=add_reward&fb_id=[user fb id]
&cherryboard_id=[cherryboard id]&user_id=[user id]&comment=[photo comment]&image_name=[photo name]
TESTED URL :-> https://www.happinesslabs.com/app_services.php?type=add_reward
 */
if($type=='add_reward'){
   $rnd=rand();
   $cherryboard_id=(int)$_REQUEST['cherryboard_id'];
   ...
   if($retval){
	  ...
	  if($image_name!=''&&$cherryboard_id>0&&$user_id>0){			   
		...
		if($insReward){
		   ...
		   $tblData['status']='Reward Added Successfully.';
		}	
	  }	
   } 
}
//START ADD TO-DOLIST 
/*
URL :-> https://www.happinesslabs.com/app_services.php?type=add_todo_list&fb_id=[user fb id]
&cherryboard_id=[cherryboard id]&user_id=[user id]&txt_todolist=[todolist text]
TESTED URL :->
https://www.happinesslabs.com/app_services.php?type=add_todo_list&fb_id=100005132283550&cherryboard_id=346&user_id=96&txt_todolist=todo list item 1*/
/*
URL :-> https://www.happinesslabs.com/app_services.php?type=delete_todo_list&fb_id=[user fb id]
&checklist_id=[checklist id]&user_id=[user id]
TESTED URL :-> https://www.happinesslabs.com/app_services.php?type=delete_todo_list&fb_id=100005132283550&checklist_id=2375&user_id=96
*/
if($type=='add_todo_list'||$type=='delete_todo_list'){	
	...
	if($type=='add_todo_list'){
		if($cherryboard_id>0&&$UserId>0&&$txt_todolist!=''){
		   ...
		   if($insTodoList){
		  	  $tblData['status']='ToDo List Added Successfully.';
		   }
		}
		...
		if($checklist_id>0&&$user_id==$UserId){
		   ...
		   if($delTodoList){
		  	  $tblData['status']='ToDo List Deleted Successfully.';
		   }
		}
	}
}
...
/*
URL :-> https://www.happinesslabs.com/app_services.php?type=add_photo_comment&fb_id=[user fb id]
&cherryboard_id=[cherryboard id]&user_id=[user id]&photo_id=[photo id]&cherry_comment=[comment text]
TESTED URL :-> https://www.happinesslabs.com/app_services.php?type=add_photo_comment&fb_id=100005132283550&cherryboard_id=346&user_id=96&photo_id=976&cherry_comment=very nice

URL :-> https://www.happinesslabs.com/app_services.php?type=delete_photo_comment&fb_id=[user fb id]
&comment_id=[comment id]&user_id=[user id]
TESTED URL :-> https://www.happinesslabs.com/app_services.php?type=delete_photo_comment&fb_id=100005132283550&comment_id=110&user_id=96
*/
if($type=='add_photo_comment'||$type=='delete_photo_comment'){
	...
	if($type=='add_photo_comment'){
		if($cherryboard_id>0&&$photo_id>0&&$UserId>0&&$cherry_comment!=''){
		   ...
		   if($insComment){
		  	  $tblData['status']='Comment Added Successfully.';
		   }
		}
		...
		if($comment_id>0&&$user_id==$UserId){
		   ...
		   if($delComments){
		  	  $tblData['status']='Comment Deleted Successfully.';
		   }
		}
	}
}
...
/*
URL :-> https://www.happinesslabs.com/app_services.php?type=add_photo_notes&fb_id=[user fb id]
&cherryboard_id=[cherryboard id]&user_id=[user id]&photo_id=[photo id]&photo_day=[photo day]&cherry_notes=[notes text]
TESTED URL :->
https://www.happinesslabs.com/app_services.php?type=add_photo_notes&fb_id=100005132283550&cherryboard_id=346&user_id=96&photo_id=976&photo_day=2&cherry_notes=My Notes

URL :-> https://www.happinesslabs.com/app_services.php?type=delete_photo_notes&fb_id=[user fb id]
&notes_id=[notes id]&user_id=[user id]
TESTED URL :-> 
https://www.happinesslabs.com/app_services.php?type=delete_photo_notes&fb_id=100005132283550&notes_id=14&user_id=96
*/
if($type=='add_photo_notes'||$type=='delete_photo_notes'){
	...
	if($type=='add_photo_notes'){
		if($cherryboard_id>0&&$photo_id>0&&$UserId>0&&$cherry_note!=''&&$photo_day>0){
		   ...
		   if($insNotes){
		  	  $tblData['status']='Note Added Successfully.';
		   }
		}
		...
		if($notes_id>0&&$user_id==$UserId){
		   ...
		   if($delNotes){
		  	  $tblData['status']='Note Deleted Successfully.';
		   }
		}
	}
}
...
/*
URL :-> https://www.happinesslabs.com/app_services.php?type=add_photo_question&fb_id=[user fb id]
&cherryboard_id=[cherryboard id]&user_id=[user id]&photo_id=[photo id]&photo_day=[photo day]&question=[question text]
TESTED URL :->
https://www.happinesslabs.com/app_services.php?type=add_photo_question&fb_id=100005132283550&cherryboard_id=346&user_id=96&photo_id=976&photo_day=2&question=How to get happiness? 

URL :-> https://www.happinesslabs.com/app_services.php?type=delete_photo_question&fb_id=[user fb id]
&question_id=[question id]&user_id=[user id]
TESTED URL :->
https://www.happinesslabs.com/app_services.php?type=delete_photo_question&fb_id=100005132283550&question_id=34&user_id=96

URL :-> https://www.happinesslabs.com/app_services.php?type=add_photo_answer&fb_id=[user fb id]
&question_id=[question id]&answer=[answer text]
TESTED URL :->
https://www.happinesslabs.com/app_services.php?type=add_photo_answer&fb_id=100005132283550&question_id=34&answer=Always think positive

URL :-> https://www.happinesslabs.com/app_services.php?type=delete_photo_answer&fb_id=[user fb id]
&question_id=[question id]&user_id=[user id]
TESTED URL :->
https://www.happinesslabs.com/app_services.php?type=delete_photo_answer&fb_id=100005132283550&question_id=34&user_id=96
*/
if($type=='add_photo_question'||$type=='add_photo_answer'||$type=='delete_photo_answer'||$type=='delete_photo_question'){
	...
	if($type=='add_photo_question'){
		...
		if($cherryboard_id>0&&$photo_id>0&&$UserId>0&&$cherry_question!=''&&$photo_day>0){
		   ...
		   if($insQuestion){
		  	  $tblData['status']='Question Added Successfully.';
		   }
		}
		...
		if($cherry_answer!=''&&$question_id>0){
		   ...
		   if($insAnswer){
		  	  $tblData['status']='Answer Added Successfully.';
		   }
		}
		...
		if($question_id>0&&$user_id==$UserId){
		   ...
		   if($delAnswer){
		  	  $tblData['status']='Answer Deleted Successfully.';
		   }
		}
		...
		if($question_id>0&&$user_id==$UserId){
		  ...
		  if($delQuestion){
		  	 $tblData['status']='Question Deleted Successfully.';
		  }
		}
	}
}
//START UPDATE STORY CODE
/*URL :-> https://www.happinesslabs.com/app_services.php?type=updatestory&fb_id=[user fb id]
&expid=[expertboard id]
TESTED URL :-> https://www.happinesslabs.com/app_services.php?type=updatestory&expid=232
*/
if($type=='updatestory'){
...
if($type=="add_user"){	
	...
	if($fb_id!=""&&$first_name!=""&&$last_name!=""&&$email!=""){
		...
		if($exist_user==0){
			...
			if($ins_query){
				$tblData['status']="Inserted";
			}
		}else{
			$tblData['status']="Exist";
		}	
	}else{
		$tblData['status']="Invalid Data";
	}
...
if($type=="add_story_photo"){
	...
	if($cherryboard_id>0&&$user_id>0&&$photo_name!=""){
		...
		if($CopyImage){
			...
			$insMebSql=mysql_query($insMeb);
			if($insMebSql){
				$tblData['status']='Photo Inserted';
			}
		}else{
			$tblData['status']='Photo Upload Error';		
		}
	}else{
		$tblData['status']='Invalid Data';
	}
...
if($type=="checkin_location"){	
	...
	//START DOIT CODE
	//https://happinesslabs.com/app_services.php?type=doit&fb_id=100002349398425&story_id=47
	if($type=='doit'){
		...
		if($expertBoardId>0&&$cherryboard_id>0&&$user_id>0){
			...
			}else{$tblData['status']='Main Board Error';}
