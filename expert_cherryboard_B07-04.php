...
<?php
 $expertCnt='';
	  ...
	  while($fetchExpertRow=mysql_fetch_array($sel_expert)){
			...
			if($expertPicPath!=""){
				$expertCnt.='<table align="center" border="0" width="95%">';
...
<a name="fb_share" type="box_count" expr:share_url="data:post.canonicalUrl" href="http://www.facebook.com/sharer.php">Share</a><script src="http://static.ak.fbcdn.net/connect.php/js/FB.Share" type="text/javascript"></script><br/><br/>
								...
								<td valign="top" width="200px">
								   ...
								   '.($expOwner_id==USER_ID?'<a href="javascript:void(0);" ondblclick="ajax_action(\'edt_exp_detail\',\'div_more_expert_'.$expertboard_id.'\',\'stype=eadd&fieldname=expertboard_detail&expertboard_id='.$expertboard_id.'&user_id='.USER_ID.'\')" title="Edit Detail" class="cleanLink">':'').' '.(trim($expert_detail)!=''?''.trim($expert_detail).'':'No expert details').'</a>					          
								   </div>
								   <br><div id="div_exp_day_'.$expertboard_id.'"> '.($expOwner_id==USER_ID?'<a href="javascript:void(0);" ondblclick="ajax_action(\'edt_exp_goal_day\',\'div_exp_day_'.$expertboard_id.'\',\'stype=eadd&expertboard_id='.$expertboard_id.'&user_id='.USER_ID.'\')" title="Edit Day" class="cleanLink"> ':'').' <font size="+1"><strong>Total : '.$goal_days.' '.$DayType.'s </strong></font></a></div>';
								   if($is_board_price==1){
								   		$expertCnt.='<div id="div_exp_price_'.$expertboard_id.'"> '.($expOwner_id==USER_ID?'<a href="javascript:void(0);" ondblclick="ajax_action(\'edt_exp_price\',\'div_exp_price_'.$expertboard_id.'\',\'stype=eadd&fieldname=price&expertboard_id='.$expertboard_id.'&user_id='.USER_ID.'\')" title="Edit Price" class="cleanLink">':'').'<font size="+1"><strong> Price : $'.$price.'</strong></font></a></div>';
								   }
								   ...
								   if($check_main_id>0){
										if($created_cherryboard_id>0&&$expOwner_id!=USER_ID){
										   $expertCnt.='<a href="expert_cherryboard.php?cbid='.$created_cherryboard_id.'" name="View Goal" class="btn_small" title="View Goal">View Goal</a><a href="expertboard.php?eid='.$expertboard_id.'&type=copy" name="Copy" class="btn_small" title="Copy" style="padding-left:20px;">Copy</a>';
										}else{
										   if($board_type==0&&$expOwner_id!=USER_ID){
										   		$expertCnt.='<a href="expertboard.php?eid='.$expertboard_id.'&type=doit" name="Doit" class="btn_small" title="Do-It">Do-It</a><a href="expertboard.php?eid='.$expertboard_id.'&type=copy" name="Copy" class="btn_small" title="Copy" style="padding-left:20px;">Copy</a>';
											}
										} 
									}
								$expertCnt.='<br/>';
						//DO-IT CUSTOMER SECTION								
						$expertCnt.='</td><td valign="top" width="150px">
	...
	<div class="wrapper">
		...
		?>
	  	...
	  	<div style="position: absolute;"><table border="0"><tr><td><a title="Sort" name="Sort" href="javascript:void(0);" onclick="javascript:ajax_action('exp_photo_refresh','right_container','cherryboard_id=<?=$cherryboard_id?>&sort=desc')"><img title="Descending" src="images/des.jpg" height="35" width="35"/></a></td><td><img id="rotate_asc" src="images/transparent.png" height="25" width="25"/></td></table></div>
			...
			<table border="0"><tr><td><img src="<?=$BuyerPic?>" class="imgsmall" style="width:25px;height:25px;" />&nbsp;</td><td valign="top"><strong><?=$BuyerName?></strong></td></tr></tr></table>
			<?php } ?>
			</div>
	  	  <?php
							  ...
							  <div class="tag_container">
								<div class="comment_box1" id="photo_title'.$photo_id.'"> '.($user_id==USER_ID?'<a href="javascript:void(0);" ondblclick="ajax_action(\'upd_photo_title\',\'photo_title'.$photo_id.'\',\'stype=eadd&photo_id='.$photo_id.'&user_id='.USER_ID.'\')" title="Edit Comment" class="cleanLink">':'').''.$photo_title.'</a></div><div class="clear"></div>
									<div class="info_box">
										...
										'.($expOwner_id==USER_ID?'<a href="javascript:void(0);"  ondblclick="ajax_action(\'edt_exp_photo_day\',\'div_photo_day'.$photo_day.'\',\'stype=eadd&photo_day='.$photo_day.'&expertboard_id='.$expertboard_id.'&user_id='.USER_ID.'\')" title="Edit Day Title" style="text-decoration:none;color:#FFFFFF;">':'').'&nbsp;'.$DaysTitleArr[$photo_day].'&nbsp;</a></div></div>
