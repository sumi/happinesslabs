...
<div id="body_container">
	<div class="wrapper" style="padding: 0px;">
	  ...
	  <div><table><tr><td><a title="Sort" name="Sort" href="javascript:void(0);" onclick="javascript:ajax_action('photo_refresh','right_container','cherryboard_id=<?=$cherryboard_id?>&sort=desc')"><img id="des" src="images/des.jpg" height="35" width="35"/></a></td><td><img id="rotate_asc" src="images/transparent.png" height="35" width="35"/></td></tr></table></div>
	  	  <?php
		 ...
		 for($i=$goal_days;$i>=1;$i--){	
			...
			$photoCnt.='<div class="main">   
   		<div class="top"><div class="img_big_container3">
								<div class="feedbox_holder">
									<div class="actions">';
									if($user_id==USER_ID){
		...
		<div class="bottom">';
			...
			if($checkCheers==0){
				$cheersLink='<div class="likes"><a href="javascript:void(0);" onclick="add_cherry_cheers(\'add_cheers\',\''.$photo_id.'\',\''.$cherryboard_id.'\',\''.USER_ID.'\')" class="likes">+give cheers!</a></div>';
			}else{$cheersLink='';}
...
$photoCnt.='</div>';
		...
		$photoCnt.='</div><div class="add">
			 <div class="add_img"><img src="'.$current_userPic.'" class="img_small" /></div>
			 <div class="add_txt">
			 <textarea name="cherry_comment_'.$photo_id.'" class="input_comments" id="cherry_comment_'.$photo_id.'" onfocus="if(this.value==\'Add a comment...\') this.value=\'\';" onblur="if(this.value==\'\') this.value=\'Add a comment...\';" style="height: 29px;width: 140px;">Add a comment...</textarea>
