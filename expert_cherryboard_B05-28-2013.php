...
<div id="body_container">
	<div class="wrapper">
		...
		<?php if($expOwner_id==USER_ID){ ?>
		  ...
		  //CHECKLIST BLOCK
			 $selchk=mysql_query("select *,date_format(record_date,'%m-%d-%Y') as record_date from tbl_app_expert_checklist where cherryboard_id=".$cherryboard_id." order by checklist_id desc ".$limit."");
			$checkCnt='';
	  ...
	  <div id="right_container" style="position: absolute;margin-left:275px;width:720px;">
		<div><table><tr><td><a title="Sort" class="btn_small" name="Sort" href="javascript:void(0);" onclick="javascript:ajax_action('exp_photo_refresh','right_container','cherryboard_id=<?=$cherryboard_id?>&sort=desc')">Descending</a></td><td><img id="rotate_asc" src="images/transparent.png" height="35" width="35"/></td></div>
	  	  <?php
