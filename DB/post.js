function showbadges(){
if(expiredBadgePoint==1){
alert("Time Period To Give Badges Expired");
return;
}
...
plarray["needhelp"]="Post what you need help with.";
plarray["canhelp"]="Post what you can help with.";
...
if(but_id=="update"|| but_id == "needhelp"|| but_id == "canhelp")
{ 
...
$(".attachment-rem").each(function (index) {
attachment_ids[index] = $(this).attr("fileid");
});
$.post(url, {
                type: posttype,
                post: post,
		...
		attachmentids: attachment_ids
				...
				$(".attach #post_attachment_links").html("");
				$(".qq-upload-list").html("");
if(data==""){
alert("Error"); 
}
else if(data==0){
alert("You Don't have sufficient points to give to these many users in post.js");
