...
<?php if(SCRIPT_NAME=="index.php"||SCRIPT_NAME=="expert_cherryboard.php"||SCRIPT_NAME=="ask_experts.php"||SCRIPT_NAME=="win_rewards.php"||SCRIPT_NAME=="index_detail.php"||SCRIPT_NAME=="add_happy_experience.php"||SCRIPT_NAME=="add_unhappy_experience.php"){ ?>
...
<?php }else{ ?>
	...
	<div id="header_cherryboard">
		...
		<div id="link_container" style="margin-left:430px;top:19px;">
		<table>
		<tr>
		<td valign="top" align="left" style="background-color:#B2B3B1">		
			<div id="sample_attach_menu_parent" class="sample_attach_two">
			<a href="#" title="Happiness Bank" style="color:#000000;padding:0px;font-weight:normal;font-size:17px">Happiness<br/>Bank</a>
			</div>
			<div id="sample_attach_menu_child">
			<a class="sample_attach_two" href="add_happy_experience.php">Add Happy Experience</a>
			<a class="sample_attach_two" href="add_unhappy_experience.php">Add Unhappy Experience</a>
			</div>
		</td>
